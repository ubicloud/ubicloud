---- MODULE StrandSchedule ----
\* Strand scheduling model with exponential backoff, crash recovery,
\* time passage, LEAST-based signaling, parent-child scheduling,
\* and hop+deadline semantics.
\*
