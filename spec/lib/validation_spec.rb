...
RSpec.describe Validation do
  describe "#validate_name" do
    ...
    describe "#validate_network_volume_config" do
      ...
      it "bounds the size by the configured floor and the type's own ceiling" do
        expect { described_class.validate_network_volume_config("gp3", 31, nil, nil) }
          .to raise_error(described_class::ValidationFailed) { |e|
            expect(e.details[:network_volume_size_gib]).to eq("Size for gp3 must be between 32 and 65536 GiB.")
          }
        expect { described_class.validate_network_volume_config("gp3", 32, nil, nil) }.not_to raise_error
        expect { described_class.validate_network_volume_config("gp3", 65_536, nil, nil) }.not_to raise_error
        expect { described_class.validate_network_volume_config("gp3", 65_537, nil, nil) }.to raise_error described_class::ValidationFailed
      end
