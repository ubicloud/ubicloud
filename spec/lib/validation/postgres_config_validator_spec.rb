...
RSpec.describe Validation::PostgresConfigValidator do
  ...
  describe "#restart_required_params" do
    ...
    it "returns restart-required params for PG 17 without archive_mode" do
      v = described_class.new("17")
      params = v.restart_required_params
      expect(params).to include("max_connections", "shared_buffers", "commit_timestamp_buffers")
      expect(params).not_to include("archive_mode")
    ...
    it "returns restart-required params for PG 18 with new params" do
      ...
      params = v.restart_required_params
      expect(params).to include("max_connections", "io_method", "io_workers", "autovacuum_worker_slots")
      expect(params).not_to include("archive_mode")
    end
