  ...
  describe "#matched_policies" do
    it "without specific object" do
      ...
      [
        ...
        [{subjects: users[0].id, actions: "Postgres:Firewall:view", objects: pg.id}, users[0].id, "Postgres:Firewall:edit", 0],
        [{subjects: users[0].id, actions: "Postgres:Firewall:edit", objects: pg.id}, users[0].id, "Postgres:Firewall:view", 0],
        [{subjects: users[0].id, actions: "Postgres:Firewall:view", objects: pg.id}, users[0].id, "Postgres:Firewall:view", 1]
