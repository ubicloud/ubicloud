...
def create_vm(**args)
  defaults = {unix_user: "ubi", public_key: "ssh-ed25519 key", name: "test-vm", family: "standard", cores: 1, memory_gib: 8, cpu_percent_limit: 200, cpu_burst_percent_limit: 0, arch: "x64", location: "hetzner-fsn1", boot_image: "ubuntu-jammy", display_state: "running", ip4_enabled: false, created_at: Time.now}
