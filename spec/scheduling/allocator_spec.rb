...
RSpec.describe Al do
  ...
  describe "candidate_selection" do
    ...
    it "retrieves correct values" do
      vmh = VmHost.create(allocation_state: "accepting", arch: "x64", location: "loc1", total_cpus: 14, total_cores: 7, used_cores: 3, total_hugepages_1g: 10, used_hugepages_1g: 2) { _1.id = Sshable.create_with_id.id }
    ...
    it "applies host filter" do
      vmh1 = VmHost.create(allocation_state: "accepting", arch: "x64", location: "loc1", total_cpus: 14, total_cores: 7, used_cores: 4, total_hugepages_1g: 10, used_hugepages_1g: 2) { _1.id = Sshable.create_with_id.id }
      vmh2 = VmHost.create(allocation_state: "accepting", arch: "x64", location: "loc1", total_cpus: 14, total_cores: 7, used_cores: 4, total_hugepages_1g: 10, used_hugepages_1g: 2) { _1.id = Sshable.create_with_id.id }
      StorageDevice.create_with_id(vm_host_id: vmh1.id, name: "stor1", available_storage_gib: 100, total_storage_gib: 100)
      StorageDevice.create_with_id(vm_host_id: vmh2.id, name: "stor1", available_storage_gib: 100, total_storage_gib: 100)
      Address.create_with_id(cidr: "1.1.1.0/30", routed_to_host_id: vmh1.id)
      Address.create_with_id(cidr: "2.1.1.0/30", routed_to_host_id: vmh2.id)
    ...
    it "applies location filter" do
      vmh1 = VmHost.create(allocation_state: "accepting", arch: "x64", location: "loc1", total_cpus: 14, total_cores: 7, used_cores: 4, total_hugepages_1g: 10, used_hugepages_1g: 2) { _1.id = Sshable.create_with_id.id }
      vmh2 = VmHost.create(allocation_state: "accepting", arch: "x64", location: "loc2", total_cpus: 14, total_cores: 7, used_cores: 4, total_hugepages_1g: 10, used_hugepages_1g: 2) { _1.id = Sshable.create_with_id.id }
      StorageDevice.create_with_id(vm_host_id: vmh1.id, name: "stor1", available_storage_gib: 100, total_storage_gib: 100)
      StorageDevice.create_with_id(vm_host_id: vmh2.id, name: "stor1", available_storage_gib: 100, total_storage_gib: 100)
      Address.create_with_id(cidr: "1.1.1.0/30", routed_to_host_id: vmh1.id)
      Address.create_with_id(cidr: "2.1.1.0/30", routed_to_host_id: vmh2.id)
