...
RSpec.describe UBID do
  ...
  it ".generate_vanity_action_type supports creating vanity ubids for action types" do
    expect(described_class.generate_vanity_action_type("Project:view").to_s).to eq "ttzzzzzzzz021g0000pr0v1ew1"
    expect(described_class.generate_vanity_action_type("ObjectTag:add").to_s).to eq "ttzzzzzzzz021g011110t0add0"
  end

  it ".generate_vanity_action_tag supports creating vanity ubids for action tags" do
    expect(described_class.generate_vanity_action_tag("Vm:all").to_s).to eq "tazzzzzzzz021g00000vm0a111"
    expect(described_class.generate_vanity_action_tag("Member").to_s).to eq "tazzzzzzzz021g00000member0"
  end
