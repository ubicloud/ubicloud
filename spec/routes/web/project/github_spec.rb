...
RSpec.describe Clover, "github" do
  ...
  describe "runner" do
    it "can list active runners" do
      ...
      runner_waiting_job = Prog::Vm::GithubRunner.assemble(installation, label: "ubicloud", repository_name: "my-repo").subject.update(ready_at: now - 400)
      ...
      runner_wo_strand = GithubRunner.create(installation_id: installation.id, label: "ubicloud", repository_name: "my-repo")
