...
RSpec.describe Clover, "cli" do
  ...
  it "produces expected output for commands" do
    ...
    gr = GithubRunner.create_with_id("d4e29b7a-5c31-8b6f-9e42-1f8a3c6d5b90", installation_id: gi.id, repository_name: "test-installation-name/test-repository-name", label: "ubicloud-standard-2", created_at: now)
    Strand.create_with_id(gr, prog: "Github::GithubRunnerNexus", label: "wait")
