...
RSpec.describe Clover, "firewall" do
  ...
  let(:firewall_rule) { FirewallRule.create_with_id(firewall_id: firewall.id, cidr: "0.0.0.0/0", port_range: Sequel.pg_range(80..5432)).tap { _1.associate_with_project(project) } }
  ...
  describe "authenticated" do
    ...
    it "success get all firewall rules" do
      FirewallRule.create_with_id(firewall_id: firewall.id, cidr: "0.0.0.0/1", port_range: firewall_rule.port_range)
      get "/api/project/#{project.ubid}/firewall/#{firewall.ubid}/firewall-rule"
    ...
    it "get firewall does not exist" do
