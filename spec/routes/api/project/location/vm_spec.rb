  ...
  describe "authenticated" do
    ...
    describe "create" do
      ...
      it "invalid boot image" do
        ...
        expect(last_response).to have_api_error(400, "Validation failed for following fields: boot_image", {"boot_image" => "\"invalid-boot-image\" is not a valid boot image name. Available boot image names are: [\"ubuntu-noble\", \"ubuntu-jammy\", \"debian-12\", \"almalinux-9\", \"almalinux-8\"]"})
      end
