  ...
  describe "unauthenticated" do
    it "cannot perform authenticated operations" do
      [
        ...
        [:delete, "/project/#{project.ubid}/location/#{vm.display_location}/vm/id/#{vm.ubid}"],
        [:get, "/project/#{project.ubid}/location/#{vm.display_location}/vm/#{vm.name}"],
        [:get, "/project/#{project.ubid}/location/#{vm.display_location}/vm/id/#{vm.ubid}"]
      ].each do |method, path|
        send method, path
  ...
  describe "authenticated" do
    ...
    describe "list" do
      ...
      it "ubid not exist" do
        get "/project/#{project.ubid}/location/#{vm.display_location}/vm/id/foo_ubid"
    ...
    describe "delete" do
      ...
      it "not exist ubid" do
        delete "/project/#{project.ubid}/location/#{vm.display_location}/vm/id/foo_ubid"
      ...
      it "not exist ubid in location" do
        delete "/project/#{project.ubid}/location/foo_location/vm/id/#{vm.ubid}"
