...
RSpec.describe Clover, "private_subnet" do
  ...
  describe "unauthenticated" do
    it "not location list" do
      get "/api/projects/#{project.ubid}/location/#{ps.location}/private-subnets"
    ...
    it "not create" do
      post "/api/projects/#{project.ubid}/location/#{ps.location}/private-subnets/foo_name"
    ...
    it "not delete" do
      delete "/api/projects/#{project.ubid}/location/#{ps.location}/private-subnets/#{ps.name}"
    ...
    it "not delete ubid" do
      delete "/api/projects/#{project.ubid}/location/#{ps.location}/private-subnets/ubid/#{ps.ubid}"
    ...
    it "not get" do
      get "/api/projects/#{project.ubid}/location/#{ps.location}/private-subnets/#{ps.name}"
    ...
    it "not get ubid" do
      get "/api/projects/#{project.ubid}/location/#{ps.location}/private-subnets/ubid/#{ps.ubid}"
  ...
  describe "authenticated" do
    ...
    describe "list" do
      it "empty" do
        get "/api/projects/#{project.ubid}/location/#{TEST_LOCATION}/private-subnets"
    ...
    describe "create" do
      it "success" do
        post "/api/projects/#{project.ubid}/location/#{TEST_LOCATION}/private-subnets/test-ps"
      ...
      it "invalid name" do
        post "/api/projects/#{project.ubid}/location/#{TEST_LOCATION}/private-subnets/invalid_name"
      ...
      it "not authorized" do
        post "/api/projects/#{project_wo_permissions.ubid}/location/#{ps_wo_permission.location}/private-subnets/foo_subnet"
    ...
    describe "show" do
      ...
      it "not found" do
        get "/api/projects/#{project.ubid}/location/#{ps.location}/private-subnets/not-exists-ps"
      ...
      it "not authorized" do
        get "/api/projects/#{project_wo_permissions.ubid}/location/#{ps_wo_permission.location}/private-subnets/#{ps_wo_permission.name}"
    ...
    describe "delete" do
      ...
      it "not exist" do
        delete "/api/projects/#{project.ubid}/location/#{ps.location}/private-subnets/foo_name"
      ...
      it "not authorized" do
        delete "/api/projects/#{project_wo_permissions.ubid}/location/#{ps_wo_permission.location}/private-subnets/#{ps_wo_permission.name}"
