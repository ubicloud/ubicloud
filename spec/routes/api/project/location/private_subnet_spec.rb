  ...
  describe "unauthenticated" do
    it "cannot perform authenticated operations" do
      [
        ...
        [:delete, "/project/#{project.ubid}/location/#{ps.display_location}/private-subnet/id/#{ps.ubid}"],
        [:get, "/project/#{project.ubid}/location/#{ps.display_location}/private-subnet/#{ps.name}"],
        [:get, "/project/#{project.ubid}/location/#{ps.display_location}/private-subnet/id/#{ps.ubid}"]
      ].each do |method, path|
        send method, path
  ...
  describe "authenticated" do
    ...
    describe "delete" do
      ...
      it "not exist ubid in location" do
        delete "/project/#{project.ubid}/location/foo_location/private-subnet/id/#{ps.ubid}"
      ...
      it "not exist ubid" do
        delete "/project/#{project.ubid}/location/#{ps.display_location}/private-subnet/id/foo_ubid"
