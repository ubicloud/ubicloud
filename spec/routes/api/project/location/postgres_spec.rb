  ...
  describe "authenticated" do
    ...
    describe "create" do
      ...
      it "clears storage auto-scale semaphores on update" do
        pg.representative_server.vm.add_vm_storage_volume(boot: false, size_gib: 128, disk_index: 0)
        pg.incr_storage_auto_scale_80_percent_action
        pg.incr_storage_auto_scale_85_percent_action
        pg.incr_storage_auto_scale_90_percent_action
        ...
        expect(Semaphore.where(strand_id:, name: "storage_auto_scale_80_percent_action").count).to eq(0)
        expect(Semaphore.where(strand_id:, name: "storage_auto_scale_85_percent_action").count).to eq(0)
        expect(Semaphore.where(strand_id:, name: "storage_auto_scale_90_percent_action").count).to eq(0)
      end
