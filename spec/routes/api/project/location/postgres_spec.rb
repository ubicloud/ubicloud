  ...
  describe "unauthenticated" do
    it "cannot perform authenticated operations" do
      ...
      [
        ...
        [:delete, "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/#{pg.ubid}"],
        [:get, "/project/#{project.ubid}/location/#{pg.display_location}/postgres/#{pg.name}"],
        [:get, "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/#{pg.ubid}"],
        ...
        [:post, "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/#{pg.ubid}/restore"],
        [:post, "/project/#{project.ubid}/location/#{pg.display_location}/postgres/#{pg.name}/reset-superuser-password"],
        [:post, "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/#{pg.ubid}/reset-superuser-password"],
        [:post, "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/#{pg.ubid}/failover"]
      ].each do |method, path|
        send method, path
  ...
  describe "authenticated" do
    ...
    describe "create" do
      ...
      it "firewall-rule pg ubid" do
        post "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/#{pg.ubid}/firewall-rule", {
          cidr: "0.0.0.0/24"
        }.to_json
    ...
    describe "show" do
      ...
      it "show firewall" do
        get "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/#{pg.ubid}/firewall-rule"
    ...
    describe "delete" do
      ...
      it "not exist ubid" do
        delete "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/foo_ubid"
      ...
      it "not exist ubid in location" do
        delete "/project/#{project.ubid}/location/foo_location/postgres/id/#{pg.ubid}"
      ...
      it "firewall-rule ubid" do
        delete "/project/#{project.ubid}/location/#{pg.display_location}/postgres/id/#{pg.ubid}/firewall-rule/#{pg.firewall_rules.first.ubid}"
