  ...
  describe "authenticated" do
    ...
    describe "create" do
      ...
      it "invalid name" do
        ...
        expect(last_response).to have_api_error(400, "Validation failed for the following fields: name", {"name" => "Name must only contain lowercase letters, numbers, and hyphens and have max length 63."})
      end
