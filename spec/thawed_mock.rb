...
module ThawedMock
  ...
  allow_mocking(PostgresServer, :[], :create, :create_with_id, :victoria_metrics_client, :parseable_client)
  ...
  allow_mocking(Prog::MachineImage::CreateVersionMetal, :assemble)
  allow_mocking(Prog::MachineImage::CreateVersionMetalFromUrl, :assemble)
  allow_mocking(Prog::MachineImage::DestroyVersionMetal, :assemble)
