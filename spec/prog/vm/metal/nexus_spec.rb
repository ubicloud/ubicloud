...
RSpec.describe Prog::Vm::Metal::Nexus do
  ...
  describe "#create_unix_user" do
    it "runs adduser with fscrypt encryption when fscrypt_key is set" do
      kek_secrets = {"algorithm" => "aes-256-gcm", "key" => Base64.encode64("k" * 32), "init_vector" => Base64.encode64("i" * 12), "auth_data" => "Ubicloud-fscrypt"}
  ...
  describe "#start" do
    ...
    it "generates fscrypt_key when host is fsencrypt_capable" do
      ...
      expect(kek_secrets["auth_data"]).to eq("Ubicloud-fscrypt")
    end
  ...
  describe "#start_after_host_reboot" do
    ...
    it "unlocks fscrypt directory before recreate-unpersisted when fscrypt_key is set" do
      kek_json = JSON.generate({"algorithm" => "aes-256-gcm", "key" => Base64.encode64("k" * 32), "init_vector" => Base64.encode64("i" * 12), "auth_data" => "Ubicloud-fscrypt"})
