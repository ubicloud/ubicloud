...
RSpec.describe Prog::Vnet::Aws::VpcNexus do
  ...
  describe "#wait_vpc_created" do
    ...
    it "creates a security group and authorizes ingress for IPv4 and IPv6 rules" do
      ...
      expect(client).to receive(:authorize_security_group_ingress).with({group_id: "sg-0123456789abcdefg", ip_permissions: [{ip_protocol: "tcp", from_port: 22, to_port: 80, ipv_6_ranges: [{cidr_ipv_6: "::/32"}]}]}).and_call_original
