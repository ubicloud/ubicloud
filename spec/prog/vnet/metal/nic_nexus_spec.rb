...
RSpec.describe Prog::Vnet::Metal::NicNexus do
  ...
  describe "#rekey" do
    ...
    it "fails if NIC not locked at start_rekey entry" do
      ...
      expect { nic_strand.unsynchronized_run }.to raise_error Strand::RunError
    end
    ...
    it "if outbound setup is not triggered, hibernates" do
      nic.update(rekey_phase: "inbound")
    ...
    it "wait_rekey_old_state_drop_trigger hibernates if trigger is not set" do
