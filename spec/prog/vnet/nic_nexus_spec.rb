...
RSpec.describe Prog::Vnet::NicNexus do
  ...
  describe ".assemble" do
    ...
    it "uses ipv6_addr if passed" do
      ...
      expect(Strand).to receive(:create_with_id).with(id, prog: "Vnet::Metal::NicNexus", label: "start", stack: [{"exclude_availability_zones" => [], "availability_zone" => nil, "ipv4_addr" => "10.0.0.12/32", "aws_subnet_id" => nil, "use_eip" => true, "create_network_interface?" => true}]).and_return(Strand.new)
