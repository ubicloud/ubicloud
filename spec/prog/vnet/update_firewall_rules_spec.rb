...
ADD_RULES
  ...
  describe "#remove_aws_old_rules" do
    ...
    it "removes old rules" do
      ...
      expect(vm.private_subnets.first).to receive(:private_subnet_aws_resource).and_return(instance_double(PrivateSubnetAwsResource, security_group_id: "sg-1234567890")).at_least(:once)
      expect(ec2_client).to receive(:describe_security_groups).with({
        group_ids: ["sg-1234567890"]
      }).and_return(instance_double(Aws::EC2::Types::DescribeSecurityGroupsResult, security_groups: [instance_double(Aws::EC2::Types::SecurityGroup, ip_permissions: [
        instance_double(Aws::EC2::Types::IpPermission,
          ip_protocol: "tcp",
          from_port: 0,
          to_port: 100,
          ip_ranges: [instance_double(Aws::EC2::Types::IpRange, cidr_ip: "0.0.0.0/0")],
          ipv_6_ranges: [instance_double(Aws::EC2::Types::Ipv6Range, cidr_ipv_6: "fd00::1/128")]),
        instance_double(Aws::EC2::Types::IpPermission,
          ip_protocol: "udp",
          from_port: 0,
          to_port: 100,
        ...
        instance_double(Aws::EC2::Types::IpPermission,
          ...
          from_port: 0,
          to_port: 100,
          ip_ranges: [instance_double(Aws::EC2::Types::IpRange, cidr_ip: "10.10.10.10/32")],
          ipv_6_ranges: []),
        instance_double(Aws::EC2::Types::IpPermission,
          ip_protocol: "tcp",
          from_port: 80,
