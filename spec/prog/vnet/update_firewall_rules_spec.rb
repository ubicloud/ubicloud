...
elements = {2a00:1450:400e:811::200e/128}
  ...
  chain forward_ingress {
    ...
    ip6 daddr fd00::1:0:0:0/80 ct state established,related,new counter accept
    ip6 saddr fd00::1:0:0:0/80 ct state established,related,new counter accept
    ...
    ip6 daddr fd00::1:0:0:0/80 ct state established,related counter accept
