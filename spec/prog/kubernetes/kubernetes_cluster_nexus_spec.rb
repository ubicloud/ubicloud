...
RSpec.describe Prog::Kubernetes::KubernetesClusterNexus do
  ...
  describe "#create_billing_records" do
    it "creates billing records for all cp vms and nodepools" do
      ...
      expect(kubernetes_cluster.active_billing_records.map { _1.billing_rate["resource_type"] }).to eq ["KubernetesCPVCpu", "KubernetesCPVCpu", "KubernetesWorkerVCpu", "KubernetesWorkerStorage"]
    end
  end
