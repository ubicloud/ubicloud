...
PGDATA=/dat/17/data
    ...
    describe "#blob_storage_client" do
      it "returns the storage client from the location credential" do
        ...
        expect(postgres_timeline).to receive(:location).and_return(instance_double(Location, location_credential: lcg, name: "us-central1", provider_dispatcher_group_name: "gcp")).at_least(:once)
