...
RSpec.describe Project do
  ...
  it "calculates current resource usage" do
    ...
    Prog::Postgres::PostgresResourceNexus.assemble(project_id: project.id, location_id: Location::HETZNER_FSN1_ID, name: "a", target_vm_size: "standard-2", target_storage_size_gib: 64, target_version: "16")
    expect(project.current_resource_usage("PostgresVCpu")).to eq 2
    Prog::Postgres::PostgresResourceNexus.assemble(project_id: project.id, location_id: Location::HETZNER_FSN1_ID, name: "b", target_vm_size: "standard-4", target_storage_size_gib: 128, target_version: "16")
