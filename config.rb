...
module Config
  ...
  # VictoriaMetrics
  optional :victoriametrics_service_project_id, string
  override :victoriametrics_host_name, "victoriametrics.ubicloud.com", string
  override :victoriametrics_version, "linux-amd64-v1.113.0"
