  ...
  if Config.unfrozen_test? && ENV["FORCE_AUTOLOAD"] == "1"
    ...
    class ModelProxy < BasicObject
      ALLOWED_CALLS = {
        ...
        ::PaymentMethod => [:fraud?],
        ::PostgresResource => [:default_network_volume_type, :default_flavor, :default_storage_type, :default_version, :default_wal_drive_type, :ha_type_none, :generate_postgres_options, :maintenance_hour_options, :network_volume_type_none, :partner_notification_flavors, :postgres_flavors, :storage_type_network_cache, :wal_drive_type_nvme],
