  ...
  label def create_network_interface
    begin
      network_interface_response = client.create_network_interface({
        ...
        groups: [private_subnet.private_subnet_aws_resource.user_security_group_id, private_subnet.private_subnet_aws_resource.mgmt_security_group_id].compact.uniq,
