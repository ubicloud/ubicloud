...
class Prog::Vnet::UpdateLoadBalancerNode < Prog::Base
  ...
  def load_balancer_ports_to_work_on
    @load_balancer_ports_to_work_on ||= load_balancer.active_vm_ports { |ds| ds.eager(:load_balancer_port, load_balancer_vm: {vm: :nics}) }.sort_by { |vm_port| vm_port.load_balancer_port.src_port }
  end
