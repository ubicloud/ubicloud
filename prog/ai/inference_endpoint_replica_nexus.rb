...
class Prog::Ai::InferenceEndpointReplicaNexus < Prog::Base
  ...
  label def wait
    uri = URI.parse("http://#{vm.ephemeral_net4}:9191")  # TODO: switch to https
    ...
    projects = if inference_endpoint.public
      ...
      [{
        ...
        api_keys: [inference_endpoint.api_key_pair.key1_hash, inference_endpoint.api_key_pair.key2_hash],
        quota_rps: 1000000.0,
        quota_tps: 1000000.0
      }]
    end
