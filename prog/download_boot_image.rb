...
class Prog::DownloadBootImage < Prog::Base
  ...
  def default_boot_image_version(image_name)
    ...
    when "ubuntu-noble-ai"
      Config.ubuntu_noble_ai_version
    else
  ...
  def sha256_sum
    hashes = {
      ...
      ["github-ubuntu-2204", "x64", "20240721.1.1"] => "5ebb741f68b78a261ba5de3b0b7f822095cd0888738a38dfc6d238f67678b0c0",
      ["github-ubuntu-2204", "arm64", "20240630.1.1"] => "b98f857ca681dc545a4159ef82298274fff0c5fdc4746cca9cd0745dd31fe868",
      ["github-ubuntu-2204", "arm64", "20240721.1.1"] => "d82a0ae8e6bd1d44b57eb208763a7228997d4bd5969566ae8ad0a0c6d4e44c1f",
      ["github-ubuntu-2004", "x64", "20240630.1.1"] => "df5bf5e6f2fa0902904506856a5af20ee6327d4fda20a4c9371f861589ca6234",
      ["github-ubuntu-2004", "x64", "20240721.1.0"] => "7a258cf673d479b5cd8be4a75a1c207f50030ecd6503a0531c74fca62f9386fd",
      ["github-ubuntu-2004", "arm64", "20240630.1.1"] => "b90fd44e9cbf0a648ecbafe593114e2b3b86e049f073f55e771cb6dd55a4fe8e",
      ["github-ubuntu-2004", "arm64", "20240721.1.0"] => "58252a9b67f48e96ae74ec2b8bc848557726270b14b2384192c05f25a1c8dc03",
      ["github-gpu-ubuntu-2204", "x64", "20240630.1.1"] => "ea802b520743b5bfc1f46518b5671be9269b7318f89d07dc5deaa2fe516ab469",
