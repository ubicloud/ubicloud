...
class Prog::Parseable::ParseableResourceNexus < Prog::Base
  ...
  def self.assemble(project_id:, name:, location_id:, admin_user:, vm_size:, storage_size_gib:)
    ...
    DB.transaction do
      ...
      parseable_resource = ParseableResource.create(
        ...
        root_cert_2:,
        root_cert_key_2:,
        blob_storage_access_key: SecureRandom.hex(16),
        blob_storage_secret_key: SecureRandom.hex(32),
  ...
  label def configure_blob_storage
    ...
    admin_client.admin_add_user(parseable_resource.blob_storage_access_key, parseable_resource.blob_storage_secret_key)
  ...
  label def destroy
    ...
    begin
      parseable_resource.blob_storage_admin_client.admin_remove_user(parseable_resource.blob_storage_access_key)
