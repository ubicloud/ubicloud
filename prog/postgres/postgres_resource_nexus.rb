...
class Prog::Postgres::PostgresResourceNexus < Prog::Base
  ...
  def self.assemble(project_id:, location_id:, name:, target_vm_size:, target_storage_size_gib:,
    ...
    DB.transaction do
      ...
      internal_firewall.replace_firewall_rules(postgres_resource.desired_internal_firewall_rules)
  ...
  label def wait
    ...
    when_update_firewall_rules_set? do
      postgres_resource.internal_firewall.replace_firewall_rules(postgres_resource.desired_internal_firewall_rules)
      servers.each { it.vm.incr_update_firewall_rules }
