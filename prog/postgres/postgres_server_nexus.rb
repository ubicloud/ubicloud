    ...
    DB.transaction do
      ...
      if postgres_resource.storage_type == PostgresResource::StorageType::NETWORK_CACHE
        ...
        unless postgres_resource.wal_drive_type == PostgresResource::WalDriveType::NVME
          storage_volumes << {encrypted: true, size_gib: [postgres_resource.target_storage_size_gib / 8, 32].max, vring_workers: 1, network_volume_type: postgres_resource.wal_drive_type}
        end
      end
