...
class Prog::Vm::Nexus < Prog::Base
  ...
  def self.assemble(public_key, project_id, name: nil, size: DEFAULT_SIZE,
    ...
    hugepages: true, ch_version: nil, firmware_version: nil, exclude_availability_zones: [], preferred_az: nil)
    ...
    DB.transaction do
      ...
      unless nic
        ...
        nic = Prog::Vnet::NicNexus.assemble(subnet.id, name: "#{name}-nic", exclude_availability_zones: exclude_availability_zones, preferred_az: preferred_az).subject
      end
