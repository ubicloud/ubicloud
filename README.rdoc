...
files as appropriate.  After the models have been setup, you can get an irb
...
routing substree (+routes/prefix1.rb+).  After that, you'll probably want to
edit the layout (+views/layout.erb+) and index page (+views/index.erb+), as
well as adding any other views.
