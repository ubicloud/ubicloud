  ...
  hash_branch(:project_prefix, "firewall") do |r|
    ...
    r.on String do |firewall_ubid|
      ...
      r.delete true do
        ...
        @firewall.firewall_rules.each { |fw| fw.dissociate_with_project(@project) }
        @firewall.destroy
      ...
      r.post "attach-subnet" do
        ...
        @firewall.associate_with_private_subnet(private_subnet, apply_firewalls: true)
      ...
      r.post "detach-subnet" do
        ...
        @firewall.disassociate_from_private_subnet(private_subnet, apply_firewalls: true)
