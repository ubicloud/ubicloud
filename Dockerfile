FROM docker.io/library/node:23.8-alpine3.21 AS frontend-builder
WORKDIR /app
...
FROM docker.io/library/ruby:3.4.2-alpine3.21 AS bundler
...
FROM docker.io/library/ruby:3.4.2-alpine3.21
