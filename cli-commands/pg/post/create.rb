...
class UbiCli
  on("pg").run_on("create") do
    ...
    options("ubi pg location/pg-name create [options]", key: :pg_create) do
      ...
      on("-W", "--wal-drive-type=type", Option.postgres_wal_drive_type_cli_values, "WAL drive type")
    ...
    help_option_values("WAL Drive Type:", Option.postgres_wal_drive_type_cli_values)
