...
Sequel.migration do
  change do
    ...
    alter_table(:load_balancer) do
      ...
      add_column :health_check_timeout, :integer, null: false, default: 10
      add_column :health_check_up_threshold, :integer, null: false, default: 2
    ...
    alter_table(:load_balancers_vms) do
      ...
      add_column :state_last_changed, :timestamp, null: false, default: Sequel::CURRENT_TIMESTAMP
    end
  end
end
