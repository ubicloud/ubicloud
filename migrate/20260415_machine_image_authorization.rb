...
Sequel.migration do
  up do
    ...
    run <<~SQL
      ...
      VALUES
        ('ffffffff-ff00-834a-87ff-ff8281028210', 'ffffffff-ff00-835a-87ff-f05020d85dc0'), -- MachineImage:all -> :view
        ('ffffffff-ff00-834a-87ff-ff8281028210', 'ffffffff-ff00-835a-87c1-40819872b4e0'), -- MachineImage:all -> :create
        ('ffffffff-ff00-834a-87ff-ff8281028210', 'ffffffff-ff00-835a-87ff-f050207343a0'), -- MachineImage:all -> :edit
        ('ffffffff-ff00-834a-87ff-ff8281028210', 'ffffffff-ff00-835a-87c1-4081ae0bb4e0'); -- MachineImage:all -> :delete
    SQL
    ...
    run <<~SQL
      INSERT INTO
        applied_action_tag (tag_id, action_id)
      VALUES
        ('ffffffff-ff00-834a-87ff-ff828ea2dd80', 'ffffffff-ff00-834a-87ff-ff8281028210'); -- Member (tazzzzzzzz021gzzzz0member0) -> MachineImage:all
    SQL
  end
