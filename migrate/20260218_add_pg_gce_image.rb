  ...
  up do
    ...
    run <<~SQL
      INSERT INTO pg_gce_image (id, gce_image_name, arch, pg_versions) VALUES
        ...
        ('d50d6770-88fe-4c13-ae92-67ec851cc10f', 'postgres-ubuntu-2204-x64-20260429-1-0', 'x64', ARRAY['16', '17', '18']::text[]),
        /* ubid z1r54160ag6h2jqmv7jsz0c9bf */
        ('c1481301-5034-47e1-95e9-b3cb3f0312b7', 'postgres-ubuntu-2204-arm64-20260429-1-0', 'arm64', ARRAY['16', '17', '18']::text[])
    SQL
  end
