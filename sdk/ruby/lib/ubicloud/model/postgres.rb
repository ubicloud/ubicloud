...
module Ubicloud
  class Postgres < Model
    ...
    set_columns :id, :name, :state, :location, :vm_size, :storage_size_gib, :version, :current_version, :ha_type, :flavor, :ca_certificates, :connection_string, :primary, :firewall_rules, :metric_destinations, :tags, :maintenance_window_start_at, :read_replica, :parent, :read_replicas
