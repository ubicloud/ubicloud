...
module Ubicloud
  class GetPostgresDatabaseDetails200Response
    ...
    attr_accessor :earliest_restore_time

    # List of Postgres firewall rules
    attr_accessor :firewall_rules

    # Latest restore time (if primary)\"
    attr_accessor :latest_restore_time
    ...
    def self.attribute_map
      {
        ...
        :'latest_restore_time' => :'latest_restore_time',
        :'primary' => :'primary'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'firewall_rules' => :'Array<PostgresFirewallRule>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Ubicloud::GetPostgresDatabaseDetails200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Ubicloud::GetPostgresDatabaseDetails200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'earliest_restore_time')
        self.earliest_restore_time = attributes[:'earliest_restore_time']
      else
        self.earliest_restore_time = nil
      end

      if attributes.key?(:'firewall_rules')
        if (value = attributes[:'firewall_rules']).is_a?(Array)
          self.firewall_rules = value
        end
      else
        self.firewall_rules = nil
      end

      if attributes.key?(:'latest_restore_time')
        self.latest_restore_time = attributes[:'latest_restore_time']
      else
        self.latest_restore_time = nil
      end
    ...
    def list_invalid_properties
      ...
      if @firewall_rules.nil?
        invalid_properties.push('invalid value for "firewall_rules", firewall_rules cannot be nil.')
      end

      if @latest_restore_time.nil?
        invalid_properties.push('invalid value for "latest_restore_time", latest_restore_time cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @firewall_rules.nil?
      return false if @latest_restore_time.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] firewall_rules Value to be assigned
    def firewall_rules=(firewall_rules)
      if firewall_rules.nil?
        fail ArgumentError, 'firewall_rules cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] latest_restore_time Value to be assigned
    def latest_restore_time=(latest_restore_time)
      if latest_restore_time.nil?
        fail ArgumentError, 'latest_restore_time cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] primary Value to be assigned
    def primary=(primary)
      if primary.nil?
        fail ArgumentError, 'primary cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          earliest_restore_time == o.earliest_restore_time &&
          firewall_rules == o.firewall_rules &&
          latest_restore_time == o.latest_restore_time &&
          primary == o.primary
    end
    ...
    def hash
      [flavor, ha_type, id, location, name, state, storage_size_gib, version, vm_size, ca_certificates, connection_string, earliest_restore_time, firewall_rules, latest_restore_time, primary].hash
    end
