  ...
  class GetVMDetails200Response
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Ubicloud::GetVMDetails200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Ubicloud::GetVMDetails200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'firewalls')
        if (value = attributes[:'firewalls']).is_a?(Array)
      ...
      if attributes.key?(:'private_ipv4')
        self.private_ipv4 = attributes[:'private_ipv4']
      else
        self.private_ipv4 = nil
      end

      if attributes.key?(:'private_ipv6')
        self.private_ipv6 = attributes[:'private_ipv6']
      else
        self.private_ipv6 = nil
      end
    ...
    def list_invalid_properties
      ...
      if @firewalls.nil?
        invalid_properties.push('invalid value for "firewalls", firewalls cannot be nil.')
      end

      if @private_ipv4.nil?
        invalid_properties.push('invalid value for "private_ipv4", private_ipv4 cannot be nil.')
      end

      if @private_ipv6.nil?
        invalid_properties.push('invalid value for "private_ipv6", private_ipv6 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @firewalls.nil?
      return false if @private_ipv4.nil?
      return false if @private_ipv6.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] firewalls Value to be assigned
    def firewalls=(firewalls)
      if firewalls.nil?
        fail ArgumentError, 'firewalls cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] private_ipv4 Value to be assigned
    def private_ipv4=(private_ipv4)
      if private_ipv4.nil?
        fail ArgumentError, 'private_ipv4 cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] private_ipv6 Value to be assigned
    def private_ipv6=(private_ipv6)
      if private_ipv6.nil?
        fail ArgumentError, 'private_ipv6 cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          firewalls == o.firewalls &&
          private_ipv4 == o.private_ipv4 &&
          private_ipv6 == o.private_ipv6 &&
          subnet == o.subnet
    end
    ...
    def hash
      [id, ip4, ip4_enabled, ip6, location, name, size, state, storage_size_gib, unix_user, firewalls, private_ipv4, private_ipv6, subnet].hash
    end
