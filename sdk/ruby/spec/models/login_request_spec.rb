...
# Unit tests for Ubicloud::LoginRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Ubicloud::LoginRequest do
  let(:instance) { Ubicloud::LoginRequest.new }

  describe 'test an instance of LoginRequest' do
    it 'should create an instance of LoginRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Ubicloud::LoginRequest)
    end
  end
