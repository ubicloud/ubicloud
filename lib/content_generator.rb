...
module ContentGenerator
  module Vm
    ...
    def self.size(location, size)
      ...
      unit_price = BillingRate.from_resource_properties("VmCpu", "standard", location)["unit_price"].to_f
  ...
  module Postgres
    ...
    def self.size(flavor, location, size)
      ...
      unit_price = BillingRate.from_resource_properties("PostgresCpu", flavor, location)["unit_price"].to_f
    ...
    def self.ha_type(flavor, location, vm_size, storage_size, ha_type)
      ...
      compute_unit_price = BillingRate.from_resource_properties("PostgresCpu", flavor, location)["unit_price"].to_f
