...
CERT_SERVICE
  ...
  # Here we are deliberately using mkdir instead of mkdir_p to avoid the bug
  # that is mentioned in this commit
  # https://github.com/ubicloud/ubicloud/commit/af0d3ed67b8b4f0e2f815298670cf39dadbc2309
