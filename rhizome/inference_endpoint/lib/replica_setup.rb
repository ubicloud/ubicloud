...
class ReplicaSetup
  def prep(inference_engine:, inference_engine_params:, model:, replica_ubid:, public_endpoint:, clover_secret:)
    ...
    write_config_files(replica_ubid, public_endpoint, clover_secret)
  ...
  def write_config_files(replica_ubid, public_endpoint, clover_secret)
