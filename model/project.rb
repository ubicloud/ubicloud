...
class Project < Sequel::Model
  ...
  feature_flag :vm_public_ssh_keys, :location_latitude_fra, :access_all_cache_scopes, :allocator_diagnostics, :private_locations, :performance_runners, :preferred_runner_locations, :postgres_metrics
end
