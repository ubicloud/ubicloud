...
class Project < Sequel::Model
  ...
  RESOURCE_ASSOCIATIONS = %i[vms minio_clusters private_subnets postgres_resources firewalls load_balancers kubernetes_clusters detachable_volumes github_runners]
