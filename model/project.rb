...
#  app_resource              | app_resource_project_id_fkey              | (project_id) REFERENCES project(id)
...
#  postgres_managed_role     | postgres_managed_role_project_id_fkey     | (project_id) REFERENCES project(id)
