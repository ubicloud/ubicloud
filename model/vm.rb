...
class Vm < Sequel::Model
  ...
  one_through_one :load_balancer, left_key: :vm_id, right_key: :load_balancer_id, join_table: :load_balancer_vm_port
  one_to_many :load_balancer_vm_port, key: :vm_id, class: :LoadBalancerVmPort
  many_to_one :vm_host_slice

  plugin :association_dependencies, sshable: :destroy, assigned_vm_address: :destroy, vm_storage_volumes: :destroy, load_balancer_vm_port: :destroy
