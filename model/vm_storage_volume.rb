...
class VmStorageVolume < Sequel::Model
  ...
  one_to_one :persistent_storage_volume
...
#  persistent_storage_volume_id | uuid    |
# Indexes:
...
#  vm_storage_volume_persistent_storage_volume_id_fkey | (persistent_storage_volume_id) REFERENCES persistent_storage_volume(id)
...
# Referenced By:
#  persistent_storage_volume | persistent_storage_volume_vm_storage_volume_id_fkey | (vm_storage_volume_id) REFERENCES vm_storage_volume(id)
