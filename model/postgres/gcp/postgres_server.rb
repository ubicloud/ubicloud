...
class PostgresServer < Sequel::Model
  module Gcp
    ...
    def gcp_refresh_walg_blob_storage_credentials
      ...
      vm.sshable.cmd("sudo install -m 600 -o postgres -g postgres /dev/stdin /etc/postgresql/gcs-sa-key.json", stdin: timeline.secret_key)
    end
    ...
    def gcp_attach_s3_policy_if_needed
      ...
      # failover/promotion switch_to_new_timeline calls attach_s3_policy_if_needed
