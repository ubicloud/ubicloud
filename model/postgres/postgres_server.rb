...
#  representative_until   | timestamp with time zone |
# Indexes:
#  postgres_server_pkey1                       | PRIMARY KEY btree (id)
#  postgres_server_res_id_rep_at_rep_until_idx | UNIQUE btree (resource_id) WHERE representative_at IS NOT NULL AND representative_until IS NULL
