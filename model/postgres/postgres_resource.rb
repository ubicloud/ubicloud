...
class PostgresResource < Sequel::Model
  ...
  def provision_new_standby
    ...
    Prog::Postgres::PostgresServerNexus.assemble(resource_id: id, timeline_id:, timeline_access: "fetch", exclude_host_ids: exclude_host_ids, exclude_availability_zones: exclude_availability_zones, availability_zone: availability_zone)
  end
