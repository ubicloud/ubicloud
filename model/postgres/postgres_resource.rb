...
#  network_volume_type_check          | (network_volume_type IS NULL OR (network_volume_type = ANY (ARRAY['gp3'::text, 'io2'::text])))
...
#  wal_drive_type_check               | (wal_drive_type = ANY (ARRAY['nvme'::text, 'gp3'::text, 'io2'::text]))
