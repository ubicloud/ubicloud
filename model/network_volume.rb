...
class NetworkVolume < Sequel::Model
  ...
  Limits = Data.define(:iops, :throughput_mibps, :max_size_gib, :max_iops_per_gib, :max_mibps_per_iops, :min_mibps_per_iops, :default_iops, :default_throughput_mibps) do
    def configurable_throughput? = !throughput_mibps.nil?
  end
  LIMITS = {
    VolumeType::GP3 => Limits.new(3000..80_000, 125..2000, 65_536, 500, 0.25, nil, 3000, 125),
    VolumeType::IO2 => Limits.new(100..256_000, nil, 65_536, 1000, nil, nil, 3000, nil),
    VolumeType::HYPERDISK_BALANCED => Limits.new(3000..160_000, 140..2400, 65_536, 500, 0.25, 1.0 / 256, 3000, 140),
  }.freeze
