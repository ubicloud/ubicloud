...
#  private_subnet_github_installation_id_uidx            | UNIQUE btree (github_installation_id)
...
#  private_subnet_github_installation_id_fkey | (github_installation_id) REFERENCES github_installation(id)
