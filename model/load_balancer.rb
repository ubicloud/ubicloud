...
class LoadBalancer < Sequel::Model
  ...
  many_to_many :vms_to_dns, class: :Vm, left_key: :load_balancer_id, right_key: :vm_id, join_table: :load_balancer_vm_port, conditions: Sequel.~(state: Sequel.any_type(["evacuating", "detaching"], :lb_node_state)), select: Sequel.lit("DISTINCT vm.*")
